...
import { SiTypescript, SiJavascript, SiMysql, SiSvelte, } from 'react-icons/si'
import { FaReact, FaDocker, FaPhp, FaLaravel, FaNodeJs, FaVuejs, FaCss3Alt, FaHtml5 } from 'react-icons/fa'
            ...
            <div className='w-screen flex justify-center items-center mt-10'>
                <div className="w-2/3 md:grid grid-cols-4 border shadow-lg md:p-10 xs:p-2 rounded-lg gap-4 ">
                    <div className='col-span-1'>
                        <figure>
                            <img src="profile.jpg" alt="" className='w-56 h-72 object-fit rounded-lg' />
                        </figure>
                    </div>

                    <div className='flex flex-col col-span-3'>
                        <div>
                            <h1 className='text-2xl font- text-blue-900'>Christian Luiz de Souza Paes</h1>
