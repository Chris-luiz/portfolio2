...
export const Conhecimentos = () => {
    return (
        <section id='conhecimentos' className="bg-white dark:bg-gray-900">
            <div className="container flex flex-col gap-10 px-6 py-12 mx-auto justify-center">
                <div className="border-l-4 pl-2 border-blue-400 rounded-sm"> 

                    <h1 className="mt-2 text-2xl font-semibold text-blue-800 md:text-3xl dark:text-white">Conhecimentos</h1>
